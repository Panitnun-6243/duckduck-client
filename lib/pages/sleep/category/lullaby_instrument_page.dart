...
class LullabyInstrumentPage extends StatefulWidget {
  const LullabyInstrumentPage({super.key});

  @override
  State<LullabyInstrumentPage> createState() => _LullabyInstrumentPageState();
}

class _LullabyInstrumentPageState extends State<LullabyInstrumentPage> {
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            List<LullabySong> songs = snapshot.data!
                                .where((song) => song.category == 'instrument')
                                .toList();
